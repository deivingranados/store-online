...
import {data} from './lady.json'
import firebase from "firebase";
import { withRouter } from 'react-router-dom';
import './satr.css';

class LedySesion extends Component {
    constructor(props) {
        super(props);
        this.state = {
            contentModal: false,
                  ...
                  <div className="content-main-log">
                   ...
                   <div className="content-enlace">
                     <img className="content-imageText" src={require('../components/images/redes.png')} />
                       ...
                       <div className="sesionText" onClick={()=>this.goSessionHome()}>Home</div>
                   </div>
                </div>
                 {this.state.date ?
...
export default withRouter(LedySesion)